        ...
        <div id = "main-dashboard thing" className="flex flex-col p-6 h-full gap-5 w-full ">
            {selectedId !== 0 && <div className="flex justify-evenly w-full">
                ...
                <div id = 'center' className="flex gap-2">
                    ...
                    <button onClick = {() => dispatch(ejectCharacter())}className="px-4 py-1.5 text-xs font-bold tracking-widest text-[#ff3333] uppercase transition-all duration-200 ease-in-out bg-transparent border border-[#ff3333]/30 hover:bg-[#ff3333]/10 hover:border-[#ff3333] hover:shadow-[0_0_12px_rgba(255,51,51,0.5)] cursor-pointer select-none">EJECT</button>
                </div>
